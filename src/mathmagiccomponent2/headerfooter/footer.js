...
fontSize:"1.3em",
    ...
    return (
        <footer className="footerlast" style={{ backgroundColor: ' rgb(63 81 181)', color:"white", padding: '20px 0' }}>
            <Container maxWidth="lg">
                <Grid container justifyContent="space-between">
                    <Grid item sm={6} xs={12}>
                        <Typography variant="body2" textAlign={{ xs: 'center', sm: 'left'  }}   >
                            &copy; {new Date().getFullYear()} Magic Sum Website. All rights reserved.
                        </Typography>
                    </Grid>
                    <Grid item sm={6} xs={12}>
